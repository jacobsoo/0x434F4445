...
{
    public partial class DateDecoder : Form
    {
        public DateDecoder()
        {
            InitializeComponent();
        ...
        private void DateDecoder_Load(object sender, EventArgs e)
        {
        ...
        private void ckbWindowTop_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                DateDecoder.ActiveForm.TopMost = true;
            }
            else
            {
                DateDecoder.ActiveForm.TopMost = false;
            }
        }

        private void ClearButton_Click(object sender, EventArgs e)
        {
            txtValueToDecode.ResetText();
